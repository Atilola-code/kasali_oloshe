...
unsupplied_router = DefaultRouter()
unsupplied_router.register(r'', views.UnsuppliedViewSet, basename='unsupplied')
...
urlpatterns = [
    ...
    # Unsupplied endpoints
    path('unsupplied/', include(unsupplied_router.urls)),
